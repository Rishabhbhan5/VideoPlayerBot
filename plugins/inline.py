...
Copyright (c) 2021  Asm Safone <https://github.com/Rishabhbhan5>
...
buttons = [
            ...
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN BOT 🤖", url="https://heroku.com/deploy?template=https://github.com/Rishabhbhan5/VideoPlayerBot"),
            ]
         ]
    ...
    if query.query == "SAF_ONE":
        answers.append(
            InlineQueryResultArticle(
                ...
                input_message_content=InputTextMessageContent(f"{REPLY_MESSAGE}\n\n<b>© Powered By : \n@RishabhHelpGroup | @Rishabhhelpbot 👑</b>", disable_web_page_preview=True),
